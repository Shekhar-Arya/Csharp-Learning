// Strings are the array of the characters.
// Example as below:
...
namespace strings
{
    public class StringsExample
    {
        ...
        {
            // defining variable of the string
            string fname, lname;
            ...
            // Arrya of the string
            char[] greeting = new char[]{'H','e','l','l','o'};

            string hello = new string(greeting);
            System.Console.WriteLine(hello);
            System.Console.WriteLine(fname+' '+lname);

            string[] bio = new string[]{"Hi!", "how are you"};

            //Join is used to join the array and form the string
            System.Console.WriteLine(String.Join(" ",bio));
            
            //Length is the property of the String
            System.Console.WriteLine(fname.Length);
...
/*
Some of the methods which we can use with the Strings
